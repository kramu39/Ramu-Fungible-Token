...
(define-constant TOKEN_URI u"https://avatars.githubusercontent.com/u/252803477?v=4&size=64") ;; RAMU token metadata URI
(define-constant TOKEN_NAME "RAMU")
(define-constant TOKEN_SYMBOL "RAMU")
